        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3">
              <h1 className="text-2xl font-bold text-gray-900">{chantier.title}</h1>
          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                ...
                className="flex items-center gap-2 border-b-2 border-transparent px-6 py-4 text-sm font-medium text-gray-600 transition-colors hover:border-primary hover:text-primary"
              >
